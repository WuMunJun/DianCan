...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      keyboardHeight: "0",
      // 键盘高度
      keyboardHeightMode: ["bottom", "center"],
      // 哪些模式需要监听键盘高度
      platform: ""
    };
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o($options.maskClick, "ff"),
    c: common_vendor.p({
      blur: $props.blur,
    ...
    n: common_vendor.o((...args) => $options.close && $options.close(...args), "98"),
    o: common_vendor.n("u-close--" + $props.closeIconPos),
    p: common_vendor.o(($event) => $options.modeCenterClose($props.mode), "73"),
    ...
    y: common_vendor.s({
      ...
      "--keyboard-height": $data.keyboardHeight
    })
  }) : {});
}
